package sdk.renren.api.client;

import sdk.renren.api.client.services.AdminService;
import sdk.renren.api.client.services.BaseService;
import sdk.renren.api.client.services.BlogService;
import sdk.renren.api.client.services.FeedService;
import sdk.renren.api.client.services.FriendsService;
import sdk.renren.api.client.services.InvitationsService;
import sdk.renren.api.client.services.NotificationsService;
import sdk.renren.api.client.services.PageService;
import sdk.renren.api.client.services.PayService;
import sdk.renren.api.client.services.PhotoService;
import sdk.renren.api.client.services.StatusService;
import sdk.renren.api.client.services.UserService;
    ...
    private void checkConfig() {
        ...
        if (renrenApiKey == null || renrenApiKey.length() < 1 || renrenApiSecret == null
            ...
            throw new RuntimeException(
                "Please init sdk.renren.api.client.RenrenApiConfig.renrenApiKey and sdk.renren.api.client.RenrenApiConfig.renrenApiSecret!");
        }
    }
